...
#SBATCH --job-name=mriqc_study-narratives_sub-05_ses-006.job
#SBATCH --output=./code/mriqc_study-narratives_sub-05_ses-006.out
#SBATCH --error=./code/mriqc_study-narratives_sub-05_ses-006.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-05/ses-006' -n bids-mriqc --input sourcedata/narratives/sub-05/ses-006/fmap/ --input sourcedata/narratives/sub-05/ses-006/func/ --output . -- -w /tmp --participant-label 05 --session-id 006 --omp-nthreads 4 --nprocs 4 -m bold --mem_gb 16 --no-datalad-get  --no-sub sourcedata/narratives ./ participant 
mriqc_exitcode=$?
