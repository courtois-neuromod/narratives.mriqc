...
#SBATCH --job-name=mriqc_study-narratives_sub-03_ses-010.job
#SBATCH --output=./code/mriqc_study-narratives_sub-03_ses-010.out
#SBATCH --error=./code/mriqc_study-narratives_sub-03_ses-010.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-03/ses-010' -n bids-mriqc --input sourcedata/narratives/sub-03/ses-010/fmap/ --input sourcedata/narratives/sub-03/ses-010/func/ --output . -- -w /tmp --participant-label 03 --session-id 010 --omp-nthreads 4 --nprocs 4 -m bold --mem_gb 16 --no-datalad-get  --no-sub sourcedata/narratives ./ participant 
mriqc_exitcode=$?
