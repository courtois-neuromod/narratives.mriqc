...
#SBATCH --job-name=mriqc_study-narratives_sub-05_ses-011.job
#SBATCH --output=./code/mriqc_study-narratives_sub-05_ses-011.out
#SBATCH --error=./code/mriqc_study-narratives_sub-05_ses-011.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-05/ses-011' -n bids-mriqc --input sourcedata/narratives/sub-05/ses-011/fmap/ --input sourcedata/narratives/sub-05/ses-011/func/ --output . -- -w /tmp --participant-label 05 --session-id 011 --omp-nthreads 4 --nprocs 4 -m bold --mem_gb 16 --no-datalad-get  --no-sub sourcedata/narratives ./ participant 
mriqc_exitcode=$?
