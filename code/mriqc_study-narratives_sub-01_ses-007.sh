...
#SBATCH --job-name=mriqc_study-narratives_sub-01_ses-007.job
#SBATCH --output=./code/mriqc_study-narratives_sub-01_ses-007.out
#SBATCH --error=./code/mriqc_study-narratives_sub-01_ses-007.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-01/ses-007' -n bids-mriqc --input sourcedata/narratives/sub-01/ses-007/fmap/ --input sourcedata/narratives/sub-01/ses-007/func/ --output . -- -w /tmp --participant-label 01 --session-id 007 --omp-nthreads 4 --nprocs 4 -m bold --mem_gb 16 --no-datalad-get  --no-sub sourcedata/narratives ./ participant 
mriqc_exitcode=$?
