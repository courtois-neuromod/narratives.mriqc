...
#SBATCH --job-name=mriqc_study-narratives_sub-02_ses-009.job
#SBATCH --output=./code/mriqc_study-narratives_sub-02_ses-009.out
#SBATCH --error=./code/mriqc_study-narratives_sub-02_ses-009.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-02/ses-009' -n bids-mriqc --input sourcedata/narratives/sub-02/ses-009/fmap/ --input sourcedata/narratives/sub-02/ses-009/func/ --output . -- -w /tmp --participant-label 02 --session-id 009 --omp-nthreads 4 --nprocs 4 -m bold --mem_gb 16 --no-datalad-get  --no-sub sourcedata/narratives ./ participant 
mriqc_exitcode=$?
